...
fn simple_flatten_if() {
    let mut commands = vec![
        ...
        Command::If {
            branches: vec![
                (
                    vec![
                        ...
                        PredicateOp::PushConst(StringOrNumber::String(
                            "finished".to_compact_string(),
                        )),
                        PredicateOp::Eq,
                    ],
            ...
            fallback_branch: vec![Command::StartNode(
                "drumroll".to_compact_string(),
            )],
        },
    ];
                ...
                vec![Command::If {
                    branches: vec![
                        (
                            vec![
                                PredicateOp::PushVar(
                                    "completion".to_compact_string(),
                                ),
                                PredicateOp::PushConst(
                            ...
                            vec![Command::StartNode(
                                "victory".to_compact_string(),
                            )],
                        ),
                        (
                            vec![
